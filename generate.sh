...
# export MODEL_PATH="/root/data/higgs/weights/higgs-audio-v2-generation-3B-base-vn"
# export MODEL_PATH="/root/data/higgs/train-higgs-audio-vi/runs/3_output_vn_lora_merged"
export MODEL_PATH="/root/data/higgs/train-higgs-audio-vi/runs/2_output_vn_lora_mini_merged"
# export MODEL_PATH="/root/data/higgs/train-higgs-audio-vi/runs/6_output_vn_lora_mini_merged"
...
--ref_audio belinda \
--temperature 0.3 \
--out_path generation-en-6-mini.wav
...
--ref_audio belinda \
--temperature 0.3 \
--out_path generation-vi-6-mini.wav